...
const Stats = ({ ipAddress, location, timezone, isp }) => {
  return (
    ...
    <div className="md:border-r-2 w-full border-slate-300 flex flex-col gap-2 items-center">
      ...
      <p className="md:text-1xl text-black font-bold">{ipAddress}</p>
    </div>
    <div className="md:border-r-2 w-full border-slate-300 flex flex-col justify-center gap-2 items-center">
      <p className="text-sm text-slate-400 font-semibold">Location</p>
      <p className="md:text-1xl text-black font-bold">{location}</p>
    </div>
    <div className="md:border-r-2 w-full border-slate-300 flex flex-col gap-2 items-center">
      <p className="text-sm text-slate-400 font-semibold">Timezone</p>
      <p className="md:text-1xl text-black font-bold">{timezone}</p>
    </div>
    <div className="w-full flex flex-col gap-2 items-center">
      <p className="text-sm text-slate-400 font-semibold">ISP</p>
      <p className="md:text-1xl text-black font-bold">{isp}</p>
